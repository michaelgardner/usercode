...
process.hlt_DiEle.HLTPaths = ["HLT_PAPhoton20_Photon15_NoCaloIdVL_v*"]
...
process.hiz0 = cms.EDAnalyzer('HiZeeAnalyzer',
    ...
    # first set of triggers should be double, second should be single. doubleTrigNum is number of double triggers you have, and controls where to go from checking double triggers (both elements must be matched) to single triggers
