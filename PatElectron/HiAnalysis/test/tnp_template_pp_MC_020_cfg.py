...
process.tnp = cms.EDAnalyzer("TagAndProbeAnalyzer",
    ...
    #outputName = cms.string('pat_MC_020.root'),
...
process.p = cms.Path(process.pACentrality_step * process.tnp)

# Schedule definition
#process.schedule = cms.Schedule(process.Z02EleElePAT,process.TagAndProbe,process.output_step,process.p)
process.schedule = cms.Schedule(process.L1Reco_step,process.Z02EleElePAT,process.TagAndProbe,process.p)
