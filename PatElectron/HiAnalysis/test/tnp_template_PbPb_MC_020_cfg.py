...
process.source.fileNames = cms.untracked.vstring('/store/group/phys_heavyions/dileptons/mgardner/Z_ee/MC_020/Reco/SD_PhotonHI_MC_9_1_E9a.root')

#process.load("PatElectron.HiAnalysis.dataset_list.MC_020_AAAA_cfi")
...
process.hiEvtPlane.vtxCollection_ = cms.InputTag(vertexCollection)
...
process.tnp = cms.EDAnalyzer("TagAndProbeAnalyzer",
    ...
    outputName = cms.string('pat_MC_020_AAAA_EEEE.root'),
...
process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('full_file_MC_020_AAAA.root'),
